    ...
    <div>
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-center">
                <form v-on:submit.prevent="createOven" class="bg-secondary text-light my-3 rounded-3" style="width: 50rem;">
                    ...
                    <div class="text-start p-3">
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary me-2">สร้างเตาอบ</button>
...
export default {
    ...
    methods: {
        async createOven() {
            try {
                await OvensService.post(this.oven)
                this.$router.push({
                    name: 'ovens'
                })
            } catch (error) {
